...
const outboundSalesStrategy = [
  ...
  return (
    <div className="flex flex-col items-center justify-center ">
      ...
      <div className="bg-outbound_bg w-screen bg-no-repeat bg-cover relative overflow-x-hidden flex flex-col justify-center items-center res-width2 max-sm:h-[430px] md:h-96">
        {/* Intro */}
        <div className="flex flex-col justify-center items-start h-full">
          ...
          <div className="flex pt-12">
            ...
            <h4 className="text-white -mt-1 ml-3 text-xl cursor-pointer" onClick={()=>navigate('/blogs/Understanding the Difference Between Scale and Growth')}>Understanding the Difference Between Scale and Growth</h4>
          </div>
        </div>
      </div>
      <div className="bg-white flex text-[18px]">
        ...
        <div className="flex flex-col md:mt-[50px] items-center justify-center mb-52">
          ...
          <div className="fflex flex-col gap-y-2 justify-start mt-[20px] md:w-[685px] md:mr-[50px]">
            ...
            <div className="flex flex-col">
                <h2 className="font-semibold text-xl">Why Outbound Sales is Important for Businesses</h2>
                <div className="flex flex-col mt-4"> {/* Added margin-top for spacing */}
            ...
            <div className="flex flex-col">
                <h2 className="font-semibold text-xl">Effective Strategies for Outbound Sales
                </h2>
                <div className="flex flex-col mt-4"> {/* Added margin-top for spacing */}
            ...
            {/*Conclusion*/}
            <h3 className="mt-5 -mb-1 font-Blinker font-bold text-xl">Conclusion</h3>
